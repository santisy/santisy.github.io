...
function uploadDiv(e, mag_bundle){
    ...
    ok_button.addEventListener("click", function(){
      ...
      axios.post('/upload/exp_images', upload_data, config).then(
        function(res){
          mag_bundle.res_d_name = res.data["dataset_name"];
          mag_bundle.res_file_paths = res.data["img_file_paths"];
          mag_bundle.res_exp_name = res.data["exp_name"];
          mag_bundle.res_img_names = res.data["img_names"];
          mag_bundle.sync_meta_data();
          reset();
          }
